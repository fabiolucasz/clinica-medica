...
async def create_clinica(
    clinica: ClinicasCreate, current_user: CurrentUser, db: SessionDep
):
...
async def update_clinica(
    id: int, clinica: ClinicasUpdate, current_user: CurrentUser, db: SessionDep
):
