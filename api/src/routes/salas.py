...
async def get_sala_by_clinica_id(clinica_id: int, current_user: CurrentUser, db: SessionDep):
...
@router.put("/salas/{id}")
async def update_sala(id: int, sala: SalasUpdate, current_user: CurrentUser, db: SessionDep):
