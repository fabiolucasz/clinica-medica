...
async def create_agendamento(
    agendamento: AgendamentosCreate, current_user: CurrentUser, db: SessionDep
):
...
async def update_agendamento(
    id: int, agendamento: AgendamentosUpdate, current_user: CurrentUser, db: SessionDep
):
...
async def update_agendamento_status(
    id: int, status_update: StatusUpdate, current_user: CurrentUser, db: SessionDep
):
