...
from src.deps.user import get_db
...
mock_db_user.hashed_password = (
    "$2b$12$yrwlr3LV767hXAlcvFRh6ugbhHhFN.y9jb6413XbhNociGMrk4N0i"
)
...
mock_session.get = lambda model, id: (
    mock_db_user if hasattr(model, "__name__") and "User" in str(model) else None
)
