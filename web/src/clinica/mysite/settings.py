...
SECRET_KEY = 'django-insecure-moqw2dm9ohfs+s-4+n8wbv$-$30y@w0rm^fi2wh3c83y+l2l%d'
...
MIDDLEWARE = [
    ...
    'mysite.middleware.TokenExpirationMiddleware',
...
# Descomente estas configurações quando usar HTTPS em produção:
